...
height = st.number_input("Minimum peak height (optional, leave 0 to ignore)", value=0.1)
prominence = st.number_input("Minimum peak prominence (optional, leave 0 to ignore)", value=0.05)
